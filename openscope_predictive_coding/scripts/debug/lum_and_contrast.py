...
if __name__ == "__main__":
    ...
    def get_stimulus(frame_length=1., t0=0, n_repeats=10):
        movie_path = os.path.join(data_path, 'lum_match_slight_contrast.npy')
    ...
    stimulus_list = get_stimulus(frame_length=.5, t0=0, n_repeats=1)
